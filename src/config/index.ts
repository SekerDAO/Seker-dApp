...
const config = {
	...
	CHAIN_ID: REACT_APP_CHAIN_ID === undefined ? DEFAULT_CONFIG.CHAIN_ID : Number(REACT_APP_CHAIN_ID),
	INFURA_NETWORK: REACT_APP_INFURA_NETWORK ?? DEFAULT_CONFIG.INFURA_NETWORK,
