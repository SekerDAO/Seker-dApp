...
const LEARN_ARTICLES: Learn = [
	{
		title: "Introduction",
		articles: [
			`Welcome to the TokenWalk V0 documentation. These pages will thoroughly outline the TokenWalk ecosystem. If you are new here, we recommend starting with the high-level overview below.`,
	...
	{
		title: "What Is the TokenWalk dApp?",
		articles: [
			`TokenWalk is a dApp to help you boot up, list, and operate your DAO! We have collaborated with Gnosis Guild on building the Zodiac Module, and have developed the Seele Module to help you achieve an unstoppable organization.`,

			`The TokenWalk dApp is catered to DAOs of all types, with the intention of building a vibrant ecosystem of communities that fosters new financial opportunities, collaborations, expression, and growth — implemented as mutually beneficial networks of DAOs.`
		],
		childArticles: [
			{
	...
	{
		title: "What Is the TokenWalkDAO?",
		articles: [
			`TokenWalkDAO is committed to ensuring that creators can release their work as public goods, meaning that they no longer need to create paywalls, rely on secondary market speculators to provide unfair royalties, or treat their work like commodities. TokenWalkDAO is shifting the focus of digital content away from solely belonging to marketplaces or auction houses.`,
			`To achieve this, we have structured TokenWalkDAO to be a retroactive public goods funding oracle similar to Optimism’s DAO. We have committed to using the TokenWalkDAOs treasury to support a landscape of creators that have shown a history of producing art, music, or any content that enriches humanity as a public good. This oracle provides a new possibility of museums of digital content — providing alternative solutions for how that content is funded, exhibited, as well as collected.`,
			`TokenWalkDAO is a community dedicated to helping other DAOs boot up with the tools we have created with Gnosis. Feel free to join our discord if you have any questions or would like more general, technical, or legal help.`
		],
		childArticles: []
	},
	{
