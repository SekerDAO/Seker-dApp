...
if (
	...
	throw new Error(
		"Required env variable REACT_APP_GNOSIS_SAFE_PROXY_FACTORY_ADDRESS not set or malformed"
	)
}
if (
	!REACT_APP_GNOSIS_SAFE_SINGLETON_ADDRESS ||
	...
	throw new Error(
		"Required env variable REACT_APP_GNOSIS_SAFE_SINGLETON_ADDRESS not set or malformed"
	)
}
